...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            github::github_list_cms_history,
            github::github_get_cms_history_details,
            github::github_load_history_content,
            github::github_prepare_content_restore,
            github::github_list_published_recipes,
            github::github_load_published_recipe,
            github::github_list_published_pages,
            github::github_load_published_page,
            github::github_load_site_configuration,
            github::github_prepare_site_publish,
            github::github_analyze_page_delete,
            github::github_prepare_page_delete,
            github::github_prepare_page_publish,
